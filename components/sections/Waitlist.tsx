...
export function Waitlist() {
  ...
  return (
    <section className="py-[160px] md:py-[200px]">
      <div className="mx-auto max-w-[1280px] px-6 text-center md:px-12 lg:px-16">
        <MonoLabel accent>{copy.waitlist.kicker}</MonoLabel>
        <h2 className="mx-auto mt-8 max-w-[980px] whitespace-pre-line font-display text-[56px] uppercase leading-[0.95] tracking-[0.02em] text-ink md:text-[80px] lg:text-[96px]">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleWaitlist} className="mx-auto mt-12 flex max-w-[620px] flex-col justify-center gap-3 md:flex-row">
            <input
              ...
              className="min-h-12 flex-1 border border-hairline bg-surface px-4 py-3 font-mono text-[14px] text-ink outline-none transition-colors placeholder:text-muted focus:border-brand md:max-w-[400px]"
            />
