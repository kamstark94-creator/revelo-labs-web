  ...
  function Button(
    ...
    return (
      <button
        ...
        type={type}
        className={cn(
          "inline-flex items-center justify-center rounded-sm font-mono uppercase tracking-[0.05em] transition-colors duration-200 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50",
