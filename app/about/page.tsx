      ...
      <main className="py-[64px] md:py-[120px]">
        <article className="mx-auto max-w-[680px] px-6 md:px-0">
          ...
          <div className="py-12 text-center">
            ...
            <p className="py-8 font-display text-[40px] uppercase leading-[1.05] tracking-[0.02em] text-ink">
              {copy.about.closing}
            </p>
            <div className="h-px w-full bg-brand/50" />
            <Link href={copy.about.cta.href} className="mt-10 inline-flex">
              <Button variant="primary" size="lg">{copy.about.cta.label}</Button>
            </Link>
          </div>
        </article>
      </main>
